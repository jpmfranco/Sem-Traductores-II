...
print('Palabra', f"{'||':>7}", 'Simbolo', f"{'||':>9}", 'Tipo', f"{' ':<9}")
print('=========================================')
for objlex in listalexico:
    if len(objlex.cad) > 3 or len(objlex.tipo) > 11:
        print(objlex.cad, f"{'||':>6}", objlex.tipo, f"{'||':>3}", objlex.pos)
        print('=========================================')

        divcad2.append(objlex.cad)
    else:
        print(objlex.cad, f"{'||':>10}", objlex.tipo, f"{'||':>4}", objlex.pos)
        print('=========================================')

        divcad2.append(objlex.cad)
input("Lexico terminado, presione enter para continuar")
divcad.clear()    
divcad=divcad2
...
print("=======================================================")
input("Sintactico terminado, presione enter para continuar") 
if len(listaerrores)!=0:
    ...
    print("=======================================================")
    input("arbol y semantico terminado, presione enter para continuar") 
    code.codigotraducido()
    print("=======================================================")
    input("Codigo ensamblador, presione enter para continuar") 
